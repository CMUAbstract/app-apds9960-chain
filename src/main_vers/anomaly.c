/* This file contains the apds test code which collects proximity data until an anomaly
 * (outside of 1st/3rd quartile of last run of data collected) is detected and then
 * switches into gesture detection mode. It currently is not instrumented to compute what
 * the gesture is, it simply reports all of the data collected
 */ 
